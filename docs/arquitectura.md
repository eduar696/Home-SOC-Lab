...
*Nota: La comunicación entre nodos se realiza a través del puerto 1514 (Wazuh Agent-to-Manager) y 1515 (Registration).*
...
### Evidencia de Red
![Validación de IP Windows 7](validar_ip.jpg)
