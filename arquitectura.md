...
<div style="display: flex; gap: 10px; margin-bottom: 20px;">
    <img src="docs/wazuh_dashboard_ready1.png" alt="wazuh dashboard ready1" width="45%">
    <img src="docs/wazuh_dashboard_ready2.png" alt="wazuh dashboard ready2" width="45%">
</div>
